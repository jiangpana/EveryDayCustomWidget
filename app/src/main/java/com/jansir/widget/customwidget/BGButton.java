...
public class BGButton extends AppCompatTextView {
    ...
    public void setTopLeftRadius(float topLeftRadius) {
        mTopLeft = topLeftRadius;
        resetRadius();
    }

    public void setTopRightRadius(float topRightRadius) {
        mTopRight = topRightRadius;
        resetRadius();
    }

    public void setBottomLeftRadius(float bottomLeftRadius) {
        mBottomLeft = bottomLeftRadius;
        resetRadius();
    }

    public void setBottomRightRadius(float bottomRightRadius) {
        mBottomRight = bottomRightRadius;
        resetRadius();
    }

    public void setRadii(float radii) {
        mTopLeft = mTopRight = mBottomRight = mBottomLeft = radii;
        resetRadius();
    }
    ...
    private void resetRadius() {
        float[] radii = new float[]{mTopLeft, mTopLeft, mTopRight, mTopRight, mBottomRight, mBottomRight, mBottomLeft, mBottomLeft};
