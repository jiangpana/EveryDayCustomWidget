 ...
 * author: jansir.
 * package: com.jansir.widget.view.countdown.
 * github:https://github.com/alidili/Demos/blob/master/CountdownDemo
 * date: 2019/6/6.
 */
public class CountdownView extends View {
    ...
    private void drawTime(Canvas canvas) {
        canvas.restore();
//         timeText = String.format(Locale.CHINA, "%02d", time) + " : 00";
        // 获取时间的宽高
    ...
    public void isStartCountDown(boolean isStartCountDown) {
        this.isStartCountDown = isStartCountDown;
    }
    ...
    public void setTimeText(String timeText) {
        ...
        rotateAngle = Integer.valueOf(split[0]) * 6;
        time = Integer.valueOf(split[0]);
        invalidate();
    }
